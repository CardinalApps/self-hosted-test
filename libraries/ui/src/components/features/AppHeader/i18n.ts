...
const i18n: StringList = {
  ...
  "major-badge.kiosk.desc": {
    "en": "<h2>Kiosk Mode</h2><p>Kiosk mode is <strong>enabled</strong> for this Media Server. When kiosk mode is enabled, some features wil behave differently:</p><ul><li>All media has been generated by AI and is royalty-free. Any similarities to real life people is purely a coincidence.</li><li>Artist images were sourced randomly from <a href='https://commons.wikimedia.org/wiki/Main_Page' target='_blank'>Wikimedia Commons</a>.</li><li>Most admin features are disabled.</li></ul>",
  },
  "major-badge.wip": {
    "en": "In Development",
  },
